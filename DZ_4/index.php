  ...
  <body>
    ...
    <div class="container">
      <div class="form-container">
        <form method="post" id="authform" class="form-horizontal" action="data_auth.php">
          <div class="form-group">
            <label for="inputEmail3" class="col-sm-2 control-label">Логин</label>
            <div class="col-sm-10">
              <input  name="login" type="text" class="form-control" id="inputEmail3" placeholder="E-mail">
                <input type="hidden" name="scr" value="authform">
            </div>
          </div>
          <div class="form-group">
